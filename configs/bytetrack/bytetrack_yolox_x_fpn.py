...
#_base_ = ['../yolox/yolox_x_8xb8-300e_ARMOT.py']
_base_ = [r"F:\mmdetection-3.3.0\configs\faster_rcnn\faster-rcnn_r50_fpn_1x_coco.py"]
# 总之看起来是之前用的yolox配置文件


dataset_type = 'MOTChallengeDataset'
# data_root = '/home/dataset/MOT17_little'#'data/MOT17/'
# data_root = '/home/dataset/GMOT40_little/images'
# data_root = '/home/dataset/ARMOT/images'
data_root = r"F:\2024-06-05-ARMOT"
# 总之改成数据集文件夹的地址
...
detector.test_cfg.rcnn.nms.update(dict(iou_threshold=0.7))
detector['init_cfg'] = dict(
    ...
    # '../../work_dirs/bytetrack_yolox_x_8xb4-80e_mot17/yolox_x_8x8_300e_coco_20211126_140254-1ef88d67.pth'
    r"C:\Users\ASUS\.cache\torch\hub\checkpoints\resnet18-f37072fd.pth"
)
del _base_.model
